...
const MobileNav = () => {
  return (
    <Sheet>
      <SheetTrigger>
        <Image alt="Mobile Navigation" src="/assets/icons/hamburger.svg" width={36} height={36} className="invert-colors sm:hidden"/>
      </SheetTrigger>
      <SheetContent side="left" className="background-light900_dark200 border-none">
        <Link href="/" className="flex items-center gap-1">
          <Image
            ...
            alt="Flowi"
          />
          <p className="h2-bold font-spaceGrotesk text-dark-100_light900 dark:text-light-900 ">
            ...
            <div className="flex flex-col gap-3">
              ...
              <SheetClose asChild>
                <Link href="/sign-up" className="flex items-center gap-3">
                  <Button className="small-medium text-dark400_light900 light-dash-border-2 btn-tertiary min-h-[41px] w-full rounded-lg px-4 py-3 shadow-none">
                    Sign up
                  </Button>
                </Link>
              </SheetClose>
